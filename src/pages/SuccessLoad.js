  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Text style={{textAlign: 'center', marginTop: 10, fontSize:20}}>has been loaded with </Text>

        <TextInput style={styles.inputBox} value={"GH₵"+this.state.CustAmount} editable={false} clearButtonMode='always' underlineColorAndroid='grey' placeholder='Customer Points'/>
        ...
        <View style={styles.signupTextCont}>
            ...
            <Text style={{marginTop: 5, fontSize:20}}>Date: <Text style={{color:'red'}}>{this.state.CustDate}</Text> </Text>
            <Text style={{marginTop: 5, fontSize:20}}>Amount: <Text style={{color:'red'}}>{this.state.CustAmount}</Text> </Text>
            <Text style={{marginTop: 5, fontSize:20}}>Station: <Text style={{color:'red'}}>{this.state.Station}</Text> </Text>
