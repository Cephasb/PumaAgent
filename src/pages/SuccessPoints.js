...
class SuccessPoints extends React.Component {
  ...
  constructor(props) {
    ...
    webCall=()=>{
     ...
     fetch('https://pumacard.perltechnologies.com/mobquery2.php',{
       method: 'POST',
       headers: {
       ...
       body: JSON.stringify({
         email: CardID
            ...
            .then((responseJson) => {
              ...
              return fetch('https://pumacard.perltechnologies.com/getpurchase.php',{
                        method: 'POST',
                        headers: {
                          'Accept': 'application/json',
                          'Content-Type': 'application/json',
                        ...
                        body: JSON.stringify({
                          cardid: CardID
                             ...
                             .then((responseJson) => {
                               this.setState({
                                 CustAmount : responseJson[0].Trans_Amount,
                                 CustDate : responseJson[0].Trans_Date,
                                 FuelType: responseJson[0].Trans_Type,
                                 isLoading: false,
                               }, function() {
                                 // In this block you can do something with new state.
                               });
  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.inputBox}>{this.state.CustAmount/10} POINTS</Text>
...
export default withNavigationFocus(SuccessPoints);
